...
Pop_12_plus=str2double(COVID_VAC_State.Administered_Dose1_Recip_12Plus)./(COVID_VAC_State.Administered_Dose1_Recip_12PlusPop_Pct./100);
Pop_5_to_11=Pop_5_plus-Pop_12_plus;
State_Single_Dose_5_to_11=zeros(length(State_ID),1);
State_Completed_Series_5_to_11=zeros(length(State_ID),1);
State_Additional_5_to_11=zeros(length(State_ID),1);
State_Bivalent_5_to_11=zeros(length(State_ID),1);
for jj=1:length(State_ID)
    tf=FIP==State_ID(jj);
    State_Single_Dose_5_to_11(jj)=(str2double(COVID_VAC_State.Administered_Dose1_Recip_5Plus(tf))-str2double(COVID_VAC_State.Administered_Dose1_Recip_12Plus(tf)))/Pop_5_to_11(tf);
    State_Completed_Series_5_to_11(jj)=(str2double(COVID_VAC_State.Series_Complete_5Plus(tf))-str2double(COVID_VAC_State.Series_Complete_12Plus(tf)))/Pop_5_to_11(tf);
    State_Additional_5_to_11(jj)=(str2double(COVID_VAC_State.Additional_Doses_5Plus(tf))-str2double(COVID_VAC_State.Additional_Doses_12Plus(tf)))/Pop_5_to_11(tf);
    State_Bivalent_5_to_11(jj)=(str2double(COVID_VAC_State.Bivalent_Booster_5Plus(tf))-str2double(COVID_VAC_State.Bivalent_Booster_12Plus(tf)))/Pop_5_to_11(tf);
end

Pop_5_plus=str2double(COVID_VAC_County.Census2019_5PlusPop);
Pop_12_plus=str2double(COVID_VAC_County.Census2019_12PlusPop);
Pop_5_to_11=Pop_5_plus-Pop_12_plus;
County_Single_Dose_5_to_11=zeros(length(County_ID),1);
County_Completed_Series_5_to_11=zeros(length(County_ID),1);
County_Additional_5_to_11=zeros(length(County_ID),1);
County_Bivalent_5_to_11=zeros(length(County_ID),1);
for jj=1:length(County_ID)
    County_Single_Dose_5_to_11(jj)=(str2double(COVID_VAC_County.Administered_Dose1_Recip_5Plus(jj))-str2double(COVID_VAC_County.Administered_Dose1_Recip_12Plus(jj)))/Pop_5_to_11(jj);
    County_Completed_Series_5_to_11(jj)=(str2double(COVID_VAC_County.Series_Complete_5Plus(jj))-str2double(COVID_VAC_County.Series_Complete_12Plus(jj)))/Pop_5_to_11(jj);
    County_Additional_5_to_11(jj)=(str2double(COVID_VAC_County.Booster_Doses_5Plus(jj))-str2double(COVID_VAC_County.Booster_Doses_12Plus(jj)))/Pop_5_to_11(jj);
    County_Bivalent_5_to_11(jj)=(str2double(COVID_VAC_County.Bivalent_Booster_5Plus(jj))-str2double(COVID_VAC_County.Bivalent_Booster_12Plus(jj)))/Pop_5_to_11(jj);
end
...
for dd=1:length(Inqv)
    ...
    X=[State_Single_Dose_5_to_11(:); County_Single_Dose_5_to_11(:)];
    X(X>=1)=1-10^(-3);
    X(X<=0)=10^(-3);
    t_n=~isnan(Y) & ~isnan(X);
    [r_Single(dd,1),r_Single(dd,2)]=corr(Y(t_n),log(X(t_n)./(1-X(t_n))));

    X=[State_Completed_Series_5_to_11(:); County_Completed_Series_5_to_11(:)];
    X(X>=1)=1-10^(-3);
    X(X<=0)=10^(-3);
    t_n=~isnan(Y) & ~isnan(X);
    ...
    X=[State_Additional_5_to_11(:); County_Additional_5_to_11(:)];
    X(X>=1)=1-10^(-3);
    X(X<=0)=10^(-3);
    t_n=~isnan(Y) & ~isnan(X);
    [r_Additional(dd,1),r_Additional(dd,2)]=corr(Y(t_n),log(X(t_n)./(1-X(t_n))));

    X=[State_Bivalent_5_to_11(:); County_Bivalent_5_to_11(:)];
    X(X>=1)=1-10^(-3);
    X(X<=0)=10^(-3);
    t_n=~isnan(Y) & ~isnan(X);
    ...
    X=[State_Single_Dose_5_to_11(:) State_Completed_Series_5_to_11(:) State_Additional_5_to_11(:) State_Bivalent_5_to_11(:);County_Single_Dose_5_to_11(:) County_Completed_Series_5_to_11(:) County_Additional_5_to_11(:) County_Bivalent_5_to_11(:);];
    
    mdl{dd}=fitlm(X,Y);
end


Age_Group={'5 to 11 years of age';'5 to 11 years of age';'5 to 11 years of age';'5 to 11 years of age'};
...
writetable(T,'Ages_5_to_11_COVID-19_Coverage.xlsx');