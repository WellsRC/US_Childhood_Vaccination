...
Y_t.National=Trust_in_Science.National.Great_Deal+0.5.*Trust_in_Science.National.Only_Some;
Y_t.National=Y_t.National(ismember(Trust_Year_Data,Data_Year));

Y_t.Male=Trust_in_Science.Sex.male.Great_Deal+0.5.*Trust_in_Science.Sex.male.Only_Some;
Y_t.Male=Y_t.Male(ismember(Trust_Year_Data,Data_Year));

Y_t.Female=Trust_in_Science.Sex.female.Great_Deal+0.5.*Trust_in_Science.Sex.female.Only_Some;
Y_t.Female=Y_t.Female(ismember(Trust_Year_Data,Data_Year));

Y_t.Age_18_34=Trust_in_Science.Age.age_18_34.Great_Deal+0.5.*Trust_in_Science.Age.age_18_34.Only_Some;
Y_t.Age_18_34=Y_t.Age_18_34(ismember(Trust_Year_Data,Data_Year));

Y_t.Age_35_49=Trust_in_Science.Age.age_35_49.Great_Deal+0.5.*Trust_in_Science.Age.age_35_49.Only_Some;
Y_t.Age_35_49=Y_t.Age_35_49(ismember(Trust_Year_Data,Data_Year));

Y_t.Age_50_64=Trust_in_Science.Age.age_50_64.Great_Deal+0.5.*Trust_in_Science.Age.age_50_64.Only_Some;
Y_t.Age_50_64=Y_t.Age_50_64(ismember(Trust_Year_Data,Data_Year));

Y_t.Age_65_plus=Trust_in_Science.Age.age_over_65.Great_Deal+0.5.*Trust_in_Science.Age.age_over_65.Only_Some;
Y_t.Age_65_plus=Y_t.Age_65_plus(ismember(Trust_Year_Data,Data_Year));

Y_t.White=Trust_in_Science.Race.white.Great_Deal+0.5.*Trust_in_Science.Race.white.Only_Some;
Y_t.White=Y_t.White(ismember(Trust_Year_Data,Data_Year));

Y_t.Black=Trust_in_Science.Race.black.Great_Deal+0.5.*Trust_in_Science.Race.black.Only_Some;
Y_t.Black=Y_t.Black(ismember(Trust_Year_Data,Data_Year));

Y_t.Other=Trust_in_Science.Race.other.Great_Deal+0.5.*Trust_in_Science.Race.other.Only_Some;
...
Err.National=Trust_in_Science_Error.National.Great_Deal+0.5.*Trust_in_Science_Error.National.Only_Some;
Err.National=Err.National(ismember(Trust_Year_Data,Data_Year));

Err.Male=Trust_in_Science_Error.Sex.male.Great_Deal+0.5.*Trust_in_Science_Error.Sex.male.Only_Some;
Err.Male=Err.Male(ismember(Trust_Year_Data,Data_Year));

Err.Female=Trust_in_Science_Error.Sex.female.Great_Deal+0.5.*Trust_in_Science_Error.Sex.female.Only_Some;
Err.Female=Err.Female(ismember(Trust_Year_Data,Data_Year));

Err.Age_18_34=Trust_in_Science_Error.Age.age_18_34.Great_Deal+0.5.*Trust_in_Science_Error.Age.age_18_34.Only_Some;
Err.Age_18_34=Err.Age_18_34(ismember(Trust_Year_Data,Data_Year));

Err.Age_35_49=Trust_in_Science_Error.Age.age_35_49.Great_Deal+0.5.*Trust_in_Science_Error.Age.age_35_49.Only_Some;
Err.Age_35_49=Err.Age_35_49(ismember(Trust_Year_Data,Data_Year));

Err.Age_50_64=Trust_in_Science_Error.Age.age_50_64.Great_Deal+0.5.*Trust_in_Science_Error.Age.age_50_64.Only_Some;
Err.Age_50_64=Err.Age_50_64(ismember(Trust_Year_Data,Data_Year));

Err.Age_65_plus=Trust_in_Science_Error.Age.age_over_65.Great_Deal+0.5.*Trust_in_Science_Error.Age.age_over_65.Only_Some;
Err.Age_65_plus=Err.Age_65_plus(ismember(Trust_Year_Data,Data_Year));

Err.White=Trust_in_Science_Error.Race.white.Great_Deal+0.5.*Trust_in_Science_Error.Race.white.Only_Some;
Err.White=Err.White(ismember(Trust_Year_Data,Data_Year));

Err.Black=Trust_in_Science_Error.Race.black.Great_Deal+0.5.*Trust_in_Science_Error.Race.black.Only_Some;
Err.Black=Err.Black(ismember(Trust_Year_Data,Data_Year));

Err.Other=Trust_in_Science_Error.Race.other.Great_Deal+0.5.*Trust_in_Science_Error.Race.other.Only_Some;
...
while(d_err>10^(-1))
    ...
    [beta_temp,err1]=surrogateopt(@(x)LS_Trust_Fit(x,Y_t,Err,S_X_t,county_weight,indx),lb,ub,options);
    ...
    [beta_temp2,err2]=fmincon(@(x)LS_Trust_Fit(x,Y_t,Err,S_X_t,county_weight,indx),beta_temp,[],[],[],[],lb,ub,[],options);
    d_err=err1-err2;
    if(err2<err1)
