function Spatial_Temporal_K_Fold_Validation(Vac,Spatial_Validation,Time_Validation_Set)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
    % Validation subsets
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
    ...
    switch Time_Validation_Set
        case 1
            Time_Validation=[2017:2018];
        case 2
            Time_Validation=[2019:2021];
        case 3
            Time_Validation=[2022:2023];
    end
    ...
    [County_Data,State_Data] = Load_Data(Vac);
    
    filter_county_train= ismember(County_Data.Spatial_Identifier,Spatial_Training) & ismember(County_Data.Year,Time_Training);
    filter_state_train= ismember(State_Data.Spatial_Identifier,Spatial_Training) & ismember(State_Data.Year,Time_Training);
    ...
    filter_county_spatial_validation= ismember(County_Data.Spatial_Identifier,Spatial_Validation) & ismember(County_Data.Year,Time_Training);
    filter_state_spatial_validation= ismember(State_Data.Spatial_Identifier,Spatial_Validation) & ismember(State_Data.Year,Time_Training);
    ...
    for sub_model=0:8
        ...
        parfor model_num=model_start:model_end
            ...
            lb=-7.*ones(1,sum(Model_Var(model_num,:))+3);
            lb(end-1:end)=-1;
            ub=7.*ones(1,sum(Model_Var(model_num,:))+3);
            ub(end-1:end)=1;
            ...
            L_temporal_val(model_num)=-Objective_Function_Coverage(par_final,County_Data_model,State_Data,filter_county_temporal_validation,filter_state_temporal_validation);
        end
    ...
    save([Vac '_Set_Spatial_Validation=' num2str(Spatial_Validation) '_Time_Validation=' num2str(Time_Validation_Set) '.mat'],'model_par','L_fit','L_spatial_val','L_temporal_val','Var_Names');
end
