...
for dd=1:4
    ...
    ax1.Position=[-0.0078    0.12    1.0156    0.7318];
    ...
    ax2.Position=[-0.0078    0.3904+0.04.*(ss-1)./100    1.0156    0.7318];
    framem off; gridm off; mlabel off; plabel off;
    end
    ...
    ax2.Position=[-0.0078    0.4354    1.0156    0.7318];
    framem off; gridm off; mlabel off; plabel off;
    ...
    ax2.Position=[-0.0078    -0.195+0.04.*(ss-1)./100    1.0156    0.7318];
    framem off; gridm off; mlabel off; plabel off;
    end
    ...
    framem off; gridm off; mlabel off; plabel off;
    exportgraphics(gcf, ['Figure_Validation_2_' char(64+dd) '.pdf']);
end
