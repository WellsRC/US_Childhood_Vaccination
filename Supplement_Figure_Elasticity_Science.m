function Supplement_Figure_Elasticity_Science
clc;
close all;
...
for vv=1:4
    ...
    if(strcmp(Vac_Nam,'IPV'))
        load(['Impact_Trust_Medicine_Science_on_Uptake_Polio_2021_Overall_Weight.mat'],'dvds');
    else
        load(['Impact_Trust_Medicine_Science_on_Uptake_' Vac_Nam '_2021_Overall_Weight.mat'],'dvds');
    end
    dvdx=dvds;
    ...
    switch vv
        ...
        text(ymin+2.5,mean([0 max(c_indx_ela)]),{['Elasticity of trust in science']},'HorizontalAlignment','center','Fontsize',18,'Rotation',270);
        axis off;     
...
print(gcf,['Supplement_Elastic_Trust_Sci.png'],'-dpng','-r600');
end