...
%% National
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','National','ReadVariableNames', true);
T_Err=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','National','ReadVariableNames', true);
...
%% Sex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Sex','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Sex','ReadVariableNames', true);
...
%% Race
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Race','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Race','ReadVariableNames', true);
...
%% Political
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Political','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Political','ReadVariableNames', true);
...
%% Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Education','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Education','ReadVariableNames', true);
...
%% Economic
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Economic','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Economic','ReadVariableNames', true);
...
%% Age
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine.xlsx'],'Sheet','Age','ReadVariableNames', true);
T_Err_temp=readtable([pwd '\Trust_Science_Medicine\Trust_in_Medicine_Error.xlsx'],'Sheet','Age','ReadVariableNames', true);
...
save(['Trust_in_Medicine_Stratification.mat'],'Trust_in_Medicine','Trust_Year_Data');
