function County_Map_Variable(Var_1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for Year_Q=2018:2021
    ...
    elseif(strcmp(Var_1,'Parental_Age')||strcmp(Var_1,'Under_5_Age')||strcmp(Var_1,'Sex')||strcmp(Var_1,'Race')||strcmp(Var_1,'Political')||strcmp(Var_1,'Education')||strcmp(Var_1,'Economic')||strcmp(Var_1,'Household_Children_under_18')||strcmp(Var_1,'Uninsured_19_under')||strcmp(Var_1,'Income'))
        [County_Demo,Data_Year]=Demographics_County(Var_1,County_ID);
        y(:,Year_Q-2017)=County_Demo(:,Data_Year==Year_Q);
        clearvars County_Demo Data_Year
    else
        y(:,Year_Q-2017)=NaN.*ones(length(County_ID),1);
    end
end

Legend_label_Name = Legend_Variable_Text(Var_1);
C=[103,0,31;178,24,43;214,96,77;244,165,130;253,219,199;247,247,247;209,229,240;146,197,222;67,147,195;33,102,172;5,48,97]./ 256;
if(max(y(:))<=1)
