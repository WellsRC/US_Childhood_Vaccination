function Discrete_Variable_Impact_Vaccination_Overall(per_inc)
...
for kk=1:4
    ...
    Vac_s=(W')*Vac_s;
    Vac_u=(W')*Vac_u;
    save(['Impact_Trust_Medicine_Science_on_Uptake_' Inqv{kk} '_' num2str(Yr) '_Disccrete_percent_inc=' num2str(per_inc*100) '_Overall_Weight.mat'],'Vac_v','Vac_m','Vac_s','Vac_u','dm','ds','du','Vac_plot');
end
end