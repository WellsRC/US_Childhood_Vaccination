function Bar_Chart_Impact_Trust_and_Uninsured(Vac_Nam)
clc;
close all;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    set(gca,'LineWidth',2,'Tickdir','out','XTick',[1:length(USFIP)],'XTickLabel',XAL,'YTick',[70:5:100],'Fontsize',16);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
   ...
   bb=zeros(length(USFIP),1);
    ...
    set(gca,'LineWidth',2,'Tickdir','out','XTick',[1:length(USFIP)],'XTickLabel',XAL,'Fontsize',16);
    xlim([0.25 length(USFIP)+0.75])
    box off;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
  subplot('Position',[0.56 0.085 0.435 0.4]);
    ...
    ytl{6}=['0.50 +'];
    set(gca,'LineWidth',2,'Tickdir','out','XTick',[1:length(USFIP)],'XTickLabel',XAL,'Fontsize',16,'YTick',[0:0.1:0.5],'Yticklabel',ytl);
    xlim([0.25 length(USFIP)+0.75])
    box off;
...
print(gcf,['Bar_' Vac_Nam '_Vaccine_Specific_Model.png'],'-dpng','-r600');
end