function Overall_Trust = Overall_State_County_Trust_Parental(county_weight,X_t,beta_all,pop_interest,yr_interest)

Trust_Stratified=Trust_Stratefied_County_Parental(county_weight,X_t,beta_all);
