function Supplement_Figure_Elasticity_Medicine
clc;
close all;
...
for vv=1:4
    ...
    if(strcmp(Vac_Nam,'IPV'))
        load(['Impact_Trust_Medicine_Science_on_Uptake_Polio_2021_Overall_Weight.mat'],'dvdm');
    else
        load(['Impact_Trust_Medicine_Science_on_Uptake_' Vac_Nam '_2021_Overall_Weight.mat'],'dvdm');
    end
    dvdx=dvdm;
    ...
    switch vv
        ...
        text(ymin+2.5,mean([0 max(c_indx_ela)]),{['Elasticity of trust in medicine']},'HorizontalAlignment','center','Fontsize',18,'Rotation',270);
        axis off;     
...
print(gcf,['Supplement_Elastic_Trust_Med.png'],'-dpng','-r600');
end